...
import socket, sys
from struct import *
from snifferGui import MyFrame

class packetSniffer():
    def __init___(self):
      self.sniff();
      self.guiFrame = MyFrame();
    ...
    def sniff():
        ...
        #parse ethernet header
            ...
            if eth_protocol == 8 :
                ...
                print 'Version : ' + str(version) + ' IP Header Length : ' + str(ihl) + ' TTL : ' + str(ttl) + ' Protocol : ' + str(protocol) + ' Source Address : ' + str(s_addr) + ' Destination Address : ' + s$
